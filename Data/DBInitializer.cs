...
{
    public static async Task SeedAsync(MomoMatsDbContext dbContext)
    {
        var desiredMats = new List<Mat>
        {
            new()
            {
                Name = "Cosmic Welcome",
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/ChatGPT_Cosmic_Welcome.png",
                Price = 29.99m,
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/ChatGPT_Neon_Circuit.png",
                Price = 34.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/ChatGPT_Mountain_Sunrise.png",
                Price = 31.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/ChatGPT_Retro_Arcade.png",
                Price = 32.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/ChatGPT_Midnight_Garden.png",
                Price = 35.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/Gemini_Ocean_Mosaic.png",
                Price = 33.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/Gemini_Desert_Horizon.png",
                Price = 29.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/Gemini_Forest_Path.png",
                Price = 34.99m,
                CreatedAt = DateTimeOffset.UtcNow
            },
            ...
            new()
            {
                ...
                ImageUrl =
                    "https://momomats.s3.us-east-1.amazonaws.com/Gemini_Abstract_Waves.png",
                Price = 31.99m,
                CreatedAt = DateTimeOffset.UtcNow
            }
        };
        ...
        foreach (var desiredMat in desiredMats)
        {
            ...
            {
                existingMat.Description = desiredMat.Description;
                existingMat.Provider = desiredMat.Provider;
                existingMat.GenerationPrompt = desiredMat.GenerationPrompt;
                existingMat.ImageUrl = desiredMat.ImageUrl;
                existingMat.Price = desiredMat.Price;
            }
            else
            {
                await dbContext.Mats.AddAsync(desiredMat);
            }
        }
